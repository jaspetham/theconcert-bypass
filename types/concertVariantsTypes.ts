export interface ConcertVariantsResponse {
  data: Data;
  bench: Bench;
}
...
export class Convert {
  public static toConcertVariantsResponse(
    json: string
  ): ConcertVariantsResponse {
    return cast(JSON.parse(json), r("ConcertVariantsResponse"));
  }

  public static ConcertVariantsResponseToJson(
    value: ConcertVariantsResponse
  ): string {
    return JSON.stringify(uncast(value, r("ConcertVariantsResponse")), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Record: o(
    [
      ...
      { json: "cost_price_text", js: "cost_price_text", typ: "" },
      { json: "price", js: "price", typ: 0 },
      { json: "price_text", js: "price_text", typ: "" },
      { json: "compare_at_price", js: "compare_at_price", typ: 0 },
      { json: "compare_at_price_text", js: "compare_at_price_text", typ: "" },
      ...
      { json: "order_quantity", js: "order_quantity", typ: null },
